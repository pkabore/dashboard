<template>
  <div class="mx-auto max-w-lg family-mono">
    <h2 class="print:hidden text-2xl font-bold mt-4 text-gray-600 text-center">
      Reçu N°{{ sale.receipt_id }}
    </h2>
    <div class="pt-4 bg-white w-full border my-7 px-4 ml-3 rounded-3xl h-full mx-auto">
      <ShopInfo />
