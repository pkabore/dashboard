            ...
            >
              ...
              <td class="p-2 font-medium">
                <span
                  ...
                  class="border border-green-600 text-green-600 text-xs px-2 py-[2px] rounded-full"
                >
                  {{ bill.status }}
                </span>
                <span
                  v-else
                  class="border border-red-600 text-red-600 text-xs px-2 py-[2px] rounded-full"
                >
                  {{ bill.status }}
                </span>
              </td>
