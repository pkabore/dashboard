<template>
	<div class="flex justify-center max-w-3xl mx-auto px-2">
		<div class="w-full">
			<h2 class="my-4 border-b text-center text-gray-600 font-bold text-2xl">Ajouter client</h2>
		    <form @submit.prevent="submit" method="post" class="mx-auto max-w-sm">
		      <div v-if="messages.clients && messages.clients.success" class="mb-1 font-medium text-sm text-green-600 flex items-center justify-end">
